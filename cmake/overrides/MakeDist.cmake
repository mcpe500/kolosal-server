...
set(_PRIMARY_BASENAMES)
foreach(_artifact IN ITEMS EXECUTABLE_PATH LIB_SERVER_PATH LIB_INFERENCE_PATH)
  if(DEFINED ${_artifact} AND EXISTS "${${_artifact}}")
    list(APPEND _PRIMARY_ARTIFACTS "${${_artifact}}")
  get_filename_component(_pname "${${_artifact}}" NAME)
  list(APPEND _PRIMARY_BASENAMES "${_pname}")
  endif()
endforeach()
...
while(_QUEUE)
  ...
  get_filename_component(_d_base "${d}" NAME)
  if(d IN_LIST _PRIMARY_ARTIFACTS OR _d_base IN_LIST _PRIMARY_BASENAMES)
      continue()
    endif()
